      ...
      <div className="width-eighty-five">
        ...
        <div className="p-3">
          <div className="position-relative">
            <h2 className="text-align-left">Emergency</h2>
            <div className="mt-3 overflow-hide">
              <table className="table-style">
                <thead className="bg-primary text-white">
                  <tr>
                    <th className="py-2 font-fiftheen">USER ID</th>
                    <th className="py-2 font-fiftheen">ASK FOR HELP</th>
                    ...
                    <th className="py-2 font-fiftheen">DATE</th>
                    <th className="py-2 font-fiftheen">TIME</th>

...
function AllPendingStatus() {
  ...
  const handleGetData = () => {
    setLoading(true)
    fetch(
      `https://policeman-project.onrender.com/PoliceApp/Admin/allPendingStatus`,
      {
        method: "GET",
        headers: {
      ...
      .then((res) => {
        setLoading(false)
        console.log("pendingComplains", res);
        setData(res.pendingComplaints
          );
      })
      .catch((err) => {
        console.log(err);
        ...
        <div className="p-3">
          <div className="position-relative">
            <div className="d-flex justify-content-between align-item-center">
              <h2 className="text-align-left">All Pending Status</h2>

              
             
              <div>
                <button onClick={handleClick} className="py-2 px-2">MISSING VEHICLE</button>
                <button onClick={handleClick} className="py-2 px-2">MISSING HUMAN</button>
                <button onClick={handleClick} className="py-2 px-2">MISSING ANIMAL</button>
                <button  onClick={handleClick} className="py-2 px-2">MISSING BAG</button>
                <button  onClick={handleClick} className="py-2 px-2">MISSING MOBILE</button>
                <button onClick={handleClick} className="py-2 px-2">MURDER</button>
                <button  onClick={handleClick} className="py-2 px-2">THEFTS</button>
                <button onClick={handleClick} className="py-2 px-2">OTHERS</button>
              </div>
            </div>
...
export default AllPendingStatus;
